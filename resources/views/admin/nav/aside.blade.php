    ...
    {{--<ul class="sidebar-menu" data-widget="tree">--}}
        ...
        <li class="treeview"><a href="#"><i class="fa fa-building"></i> <span>Administrator</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
            <ul class="treeview-menu">
                {{--Menu year--}}
